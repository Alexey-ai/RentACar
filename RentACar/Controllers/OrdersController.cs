...
namespace RentACar.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["DriverID"] = new SelectList(_context.Drivers, "ID", "FName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("OrderID,CarID,DriverID,OrderDate,OdometerStart,FuelStart,OrderReturnDate,OdometerFinish,FuelFinish,NumberofDays,ExtraMileage,Price")] Order order)
        {
